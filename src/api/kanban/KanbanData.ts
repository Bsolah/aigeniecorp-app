...
import { TodoCategory } from '../../types/apps/kanban.ts';
...
KanbanData.forEach((category) => {
  category.child.forEach((task: any) => {
...
mock.onDelete('/api/TodoData').reply((config: any) => {
...
mock.onDelete('/api/TodoData/clearTasks').reply((config: any) => {
...
mock.onPost('/api/TodoData/addTask').reply((config: any) => {
...
mock.onPost('/api/TodoData/addCategory').reply((config: any) => {
...
mock.onPost('/api/TodoData/updateCategory').reply((config: any) => {
...
mock.onPut('/api/TodoData/editTask').reply((config : any) => {
...
mock.onDelete('/api/TodoData/deleteTask').reply((config: any) => {
