      ...
      <div className="p-2">
        <div className="flex gap-5 p-2 justify-between text-center">
          ...
          <span className="flex gap-5 p-2 justify-between items-center">
            ...
            <Btn className="ui-button bg-primary" onClick={handleCreatePage}>
              Publish
            </Btn>
          </span>
        </div>
        <div>
          <div
            className="flex gap-5  justify-center flex-wrap p-4"
            style={{ borderTop: '0.5px solid', borderBottom: '1px solid' }}
          >
