          ...
          <div className="md:col-span-7 col-span-12">
            ...
            <div className="flex  w-full xl:mt-12 sm:mt-12 lg:mt-6 mt-6">
              <div className="border-e border-white/20 pe-4">
                <p className="text-white opacity-75 text-sm mb-1">Ongoing Projects</p>
                <h2 className="text-white text-2xl">34</h2>
              </div>
              <div className="ps-4"> 
                <p className="text-white opacity-75 text-sm mb-1">Saved Hours this week</p>
                <h2 className="text-white text-2xl">403</h2>
              </div>
            </div>
          </div>
