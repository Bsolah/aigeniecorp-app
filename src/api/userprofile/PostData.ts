import { PostType } from '../../types/apps/userProfile.ts';
...
mock.onPost('/api/data/posts/like').reply((config: any) => {
  try {
...
mock.onPost('/api/data/posts/comments/add').reply((config: any) => {
  try {
...
mock.onPost('/api/data/posts/replies/add').reply((config: any) => {
  try {
...
mock.onPost('/api/data/posts/replies/like').reply((config: any) => {
  try {
