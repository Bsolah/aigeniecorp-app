...
import { InvoiceList } from '../../types/apps/invoice.ts';
...
mock.onDelete('/api/data/invoicedata/deleteinvoice').reply((config: any) => {
...
mock.onPost('/api/data/invoicedata/addinvoice').reply((config: any) => {
...
mock.onPut('/api/data/invoicedata/updateinvoice').reply((config: any) => {
